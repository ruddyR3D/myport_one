...
//   return (
//     <section className='relative isolate mx-auto flex w-full max-w-360 flex-col items-center bg-transparent py-10 text-white md:py-20'>
...
//           <h2 className='text-display-sm md:text-display-xl w-full max-w-[847px] text-center leading-[38px] font-bold tracking-[-0.02em] md:leading-[56px] md:tracking-[-0.03em]'>
...
//               variant='outline'
//               size='default'
//               className='group size-[45px] rounded-full border border-neutral-300 bg-white p-[10px] ring-1 ring-[#E5E7EB] hover:bg-transparent hover:shadow-[0_0_32px_rgba(0,0,0,0.6)] focus-visible:ring-2 focus-visible:ring-neutral-950/20'
//               title='Previous'
//             >
//               <Image
//                 src='/icons/left2.svg'
...
export default function TesSection() {
  ...
  // ==== ANIMASI FRAMER MOTION (drop-in + stagger) ====
  ...
  return (
    ...
    >
      ...
      >
        {/* HEADER */}
        <motion.div
          className='mx-auto flex w-full flex-col items-center gap-2 text-[#0A0D12]'
          variants={itemDrop}
        >
          <h2 className='text-display-sm md:text-display-xl w-full max-w-[847px] text-center leading-[38px] font-bold tracking-[-0.02em] md:leading-[56px] md:tracking-[-0.03em]'>
            What They Say About Working With Me
        ...
        {/* STACK KARTU (masuk turun dengan stagger) */}
        <motion.div
          className='relative mx-auto flex w-full flex-col gap-12 md:gap-6'
          variants={container}
        >
          <motion.div
            className='relative z-[2] h-[473px] w-full md:h-[440px]'
            variants={itemDrop}
          >
